/* Simple SVG icon components for VectorScan */

export function IconScan({ size = 20, color = 'currentColor' }) {
  return (
...
export function IconCpu({ size = 20, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
